...
require("searchanimals-db.php"); // Include the file containing search functionality
?>
...
<body>
    ...
    <div>
        ...
        <div>   
            <form method="post" action="searchanimals.php">
                ...
                <select id="breed" name="breed" style="width: 200px;">
    ...
    <div class="card-container" style="display: flex; flex-wrap: wrap; justify-content: space-around; margin: 0 auto; max-width: 1200px;">
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $animals = searchPets($searchCriteria, $nickname);

            foreach ($animals as $animal) {
                //echo "Animal ID: " . $animal['animal_id'] . "<br>";
                echo '<div class="card" style="width: 250px; margin-top: 20px; text-align: center;">';

                //pet
                if (!empty($animal['pet_nickname'])) {
                    echo '<h3 style="background: lavender;">Pet</h3>';
                    echo "<div>";
                    echo "<p>Species: " . $animal['species'] . "</p>";
                    echo "<p>Nickname: " . $animal['pet_nickname'] . "</p>";
                    
                }
                //lost animal
                elseif (!empty($animal['pet_condition'])) {
                    echo '<h3 style="background: pink">Lost Animal</h3>';
                    echo "<div>";
                    echo "<p>Species: " . $animal['species'] . "</p>";
                    echo "<p>Condition: " . $animal['pet_condition'] . "</p>";
                    echo "<p>Street Name: " . $animal['found_street_name'] . "</p>";
                    echo "<p>Zip Code: " . $animal['found_zip_code'] . "</p>";
                    echo "<p>City: " . $animal['found_city'] . "</p>";
                }
                //stray
                elseif (!empty($animal['stray_nickname'])) {
                    echo '<h3 style="background: #89CFF0">Stray</h3>';
                    echo "<div>";
                    echo "<p>Species: " . $animal['species'] . "</p>";
                    echo "<p>Stray Nickname: " . $animal['stray_nickname'] . "</p>";
                    echo "<p>Zip Code: " . $animal['zip_code'] . "</p>";
                    echo "<p>Sociability: " . $animal['sociability'] . "</p>";
                }
                //should ever see this message
                else {
                    echo "<p>Animal information not available.</p>";
                }
                
                echo "<p>Breed: " . $animal['breed'] . "</p>";
                echo "<p>Fur Color: " . $animal['fur_color'] . "</p>";
                echo "<p>Fur Pattern: " . $animal['fur_pattern'] . "</p>";
                echo "<p>Eye Color: " . $animal['eye_color'] . "</p>";
                echo "<p>Size: " . $animal['pet_size'] . "</p>";
                echo '</div>';
                echo '</div>';
                echo "<br>";         
            }

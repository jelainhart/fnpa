...
function addPet($species, $breed, $fur_color, $fur_pattern, $eye_color, $size, $additional_description, $nickname)
{
   ...
   $animal_query = "INSERT INTO Animal (species, breed, fur_color, fur_pattern, eye_color, size, additional_description) VALUES (:species, :breed, :fur_color, :fur_pattern, :eye_color, :size, :additional_description)";  
